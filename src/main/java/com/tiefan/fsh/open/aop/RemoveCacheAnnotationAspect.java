...
@Aspect 
@Component
public class RemoveCacheAnnotationAspect {

    public RemoveCacheAnnotationAspect() {
    ...
    @Pointcut("@annotation(com.tiefan.fsh.open.annotation.RemoveLocalCache)")
    ...
    public Object invoke(ProceedingJoinPoint invocation) throws Throwable {
        ...
        return processor.removeLocalCacheAnnotation(invocation);
    }
}
